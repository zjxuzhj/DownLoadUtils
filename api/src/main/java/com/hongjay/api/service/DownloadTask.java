...
public class DownloadTask {
    ...
    private DownloadListener apkDownloadListener;
    private String baseUrl;

    public DownloadTask(String downloadUrl, String filePath, DownloadListener apkDownloadListener, String baseUrl) {
    ...
    public void start() {
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, final Response<ResponseBody> response) {
                ...
                //注意，这个方法是运行在子线程中的
                writeResponseToDisk(filePath, response, apkDownloadListener);
            }

            @Override
            public void onFailure(Call<ResponseBody> call, Throwable throwable) {
                apkDownloadListener.onFail("网络错误");
            }
        });
    }
